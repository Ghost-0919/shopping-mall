<template>
    <div class="cate">
        ...
        <!-- 添加编辑对话框 -->
        <el-dialog title="修改分类" :visible.sync="CateVisible" width="40%">
            <el-form
                :model="addCateForm"
...
export default {
    ...
    methods: {
        ...
        //选择项发生变化触发这个函数
        parentCateChange() {
            //如果selectedKeys的length大于0证明选中的父级分类
        ...
        //点击编辑分类展示
        async CateAlterVisible(name, id) {
            this.CateVisible = true
            this.addCateForm.cat_name = name
        ...
        async editCate() {
            ...
            const { data: res } = await this.$http.put(
                'categories/' + this.addCateForm.cat_pid,
                {
